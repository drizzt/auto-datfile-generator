...
![Daily Rebuild Status](https://github.com/drizzt/auto-datfile-generator/actions/workflows/daily-rebuild.yml/badge.svg)
...
`https://github.com/drizzt/auto-datfile-generator/releases/latest/download/no-intro.xml`

### No-Intro (parent-clone)

`https://github.com/drizzt/auto-datfile-generator/releases/latest/download/no-intro_parent-clone.xml`

### Redump

`https://github.com/drizzt/auto-datfile-generator/releases/latest/download/redump.xml`
